...
<h1><span class="yellow">Faculty Information</span></h1>

<table class="container">
	<thead>
		<tr>
			<th><h1>FACULTY_ID</h1></th>
			<th><h1>FACULTY_NAME</h1></th>
			<th><h1>QUALIFICATION</h1></th>
			<th><h1>AGE</h1></th>
...
$sql="SELECT f_id,f_name,qualification,age,designation FROM faculty";
$result=$conn->query($sql);
if($result->num_rows > 0){
while($row=$result->fetch_assoc()){
	echo "<tbody><tr><td>" .$row["f_id"]. "</td><td>" .$row["f_name"] ."</td><td>" .$row["qualification"]. "</td><td> "  . $row["age"]. "</td><td> "  . $row["designation"]. "</td></tr>";
}
echo "</tbody>
</table>
</body>
