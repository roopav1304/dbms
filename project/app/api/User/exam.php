...
<h1><span class="yellow">Exam Information</span></h1>

<table class="container">
	<thead>
		<tr>
			<th><h1>EXAM_ID</h1></th>
			<th><h1>EXAM_NAME</h1></th>
			<th><h1>EXAM_DATE</h1></th>
			<th><h1>TIMINGS</h1></th>
                                 </tr>
	</thead>
...
$sql="SELECT exam_id,exam_name,exam_date,timings FROM exam";
$result=$conn->query($sql);
if($result->num_rows > 0){
while($row=$result->fetch_assoc()){
	echo "<tbody><tr><td>" .$row["exam_id"]. "</td><td>" .$row["exam_name"] ."</td><td>" .$row["exam_date"]. "</td><td> "  . $row["timings"]. "</td></tr>";
}
echo "</tbody>
</table>
</body>
