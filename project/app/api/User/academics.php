...
<h1><span class="yellow">Academic Information</span></h1>
...
//if(strlen($url))==
$sql="SELECT A.c_id,A.grade,A.attendance  FROM academics A,login L WHERE A.s_id=L.id AND L.username='".$_SESSION['username']."'" ;
$result=$conn->query($sql);
if($result->num_rows > 0){
while($row=$result->fetch_assoc()){
	echo "<tbody><tr><td>".$row["c_id"]."</td><td>".$row["grade"]."</td><td>".$row["attendance"]."</td></tr>";
}
echo "
</tbody>
</table>
...
echo "<html>
	<body>
	<p style='color:white;' class='error' > No data available!</p>
	</body>
	</html>";
}
