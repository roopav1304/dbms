...
<h1><span class="yellow">Department Information</span></h1>

<table class="container">
	<thead>
		<tr>
			<th><h1>DEPARTMENT_ID</h1></th>
			<th><h1>DEPARTMENT_NAME</h1></th>
			<th><h1>HOD_ID</h1></th>
...
$sql="SELECT d_id,d_name,hod_id FROM department";
$result=$conn->query($sql);
if($result->num_rows > 0){
while($row=$result->fetch_assoc()){
	echo "<tbody><tr><td>" .$row["d_id"]. "</td><td>" .$row["d_name"] ."</td><td>" .$row["hod_id"]. "</td></tr>";
}
echo "</tbody>
</table>
</body>
